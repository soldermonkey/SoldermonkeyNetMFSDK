...
namespace Gadgeteer.Modules.SolderMonkey
{
    ...
    public class ADC_Mux : GTM.Module
    {
        ...
        // GTM.SolderMonkey.ADC_Mux. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the ADC_Mux module.        
        ...
        public ADC_Mux(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the ADC_Mux is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="ADC_Mux"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="ADC_Mux"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="ADC_Mux"/></param>
        public delegate void ButtonEventHandler(ADC_Mux sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="ADC_Mux"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="ADC_Mux"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="ADC_Mux"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(ADC_Mux sender, ButtonState buttonState)
        {
